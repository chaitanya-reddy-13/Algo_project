  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-foreground border border-border/20 hover:shadow-glow hover:scale-105 backdrop-blur-sm",
        success: "bg-success text-foreground hover:bg-success/90",
        warning: "bg-warning text-foreground hover:bg-warning/90",
        code: "bg-code-bg border border-code-border text-foreground hover:bg-muted font-mono",
      },
      size: {
